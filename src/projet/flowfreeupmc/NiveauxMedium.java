...
public class NiveauxMedium extends Activity implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {  
		...
		setContentView(R.layout.niveaux_medium);
		fma = (FlowModelApp)this.getApplicationContext() ;
		G1=(Button)findViewById(R.id.Bouton_gm1);
	    G2=(Button)findViewById(R.id.Bouton_gm2);
	    G3=(Button)findViewById(R.id.Bouton_gm3);
	...
	public void onClick(View view) {
    	...
    	if (view.equals(G1)){
    		intent.putExtra("choix_niveau", 3);
        }else if (view.equals(G2)){
        	intent.putExtra("choix_niveau", 4);
        }else if (view.equals(G3)){
            intent.putExtra("choix_niveau", 5);
        }
